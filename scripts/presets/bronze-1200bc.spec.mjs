...
export default {
  ...
  polities: {
    EGYP: { name: "New Kingdom Egypt", color: "#c9a227", aliases: ["신왕국 이집트", "Egypt", "Kemet", "Pharaoh's realm", "the Two Lands"] },
    HATT: { name: "Hittite Empire", color: "#8f5a3f", aliases: ["히타이트 제국", "Hatti", "the Hittites", "the Great King of Hatti"] },
    ASSY: { name: "Middle Assyrian Empire", color: "#7a3f3f", aliases: ["중아시리아 제국", "Assyria", "Assur"] },
    BABY: { name: "Kassite Babylonia", color: "#3f6ab8", aliases: ["카시트 바빌로니아", "Babylon", "Karduniash", "the Kassites"] },
    ELAM: { name: "Elam", color: "#9a6a3a", aliases: ["엘람", "Susa and Anshan", "the Elamites"] },
    MYCE: { name: "Mycenaean Kingdoms", color: "#4a78c0", aliases: ["미케네 왕국들", "Ahhiyawa", "the Achaeans", "Mycenae"] },
    WILU: { name: "Wilusa", color: "#6a8a3a", aliases: ["윌루사", "Troy", "Ilios"] },
    ALAS: { name: "Alashiya", color: "#3f9a8a", aliases: ["알라시야", "Cyprus", "the copper island"] },
    LIBU: { name: "Libu Tribes", color: "#8a7a4a", aliases: ["리부 부족", "Libya", "the Libu and Meshwesh"] },
    SHAN: { name: "Shang Dynasty", color: "#b8860b", aliases: ["상나라", "Shang", "Yin", "China"] },
    SHUU: { name: "Kingdom of Shu", color: "#5a9a5a", aliases: ["고촉", "Sanxingdui", "ancient Shu"] },
    OLME: { name: "Olmec", color: "#7a5c8a", aliases: ["올멕", "the Olmecs", "San Lorenzo"] },
  },
