...
export default {
  ...
  polities: {
    ...
    RSF: { name: "Russian SFSR", color: "#9e2222", aliases: ["러시아 SFSR", "Russian Soviet Federative Socialist Republic", "RSFSR", "Russia", "Soviet Union", "소련"] },
    UKS: { name: "Ukrainian SSR", color: "#a83030", aliases: ["우크라이나 SSR", "우크라이나", "Ukraine"] },
    BYE: { name: "Byelorussian SSR", color: "#932828", aliases: ["벨로루시 SSR", "백러시아", "Byelorussia", "Belarus"] },
    GEO: { name: "Georgian SSR", color: "#8e2020", aliases: ["그루지야 SSR", "조지아", "Georgia"] },
    ARM: { name: "Armenian SSR", color: "#a02a2a", aliases: ["아르메니아 SSR", "아르메니아", "Armenia"] },
    ...
    EST: { name: "Estonian SSR", color: "#b04242", aliases: ["에스토니아 SSR", "에스토니아", "Estonia"] },
    LVA: { name: "Latvian SSR", color: "#aa3c3c", aliases: ["라트비아 SSR", "라트비아", "Latvia"] },
    LTU: { name: "Lithuanian SSR", color: "#b44848", aliases: ["리투아니아 SSR", "리투아니아", "Lithuania"] },
