...
export default {
  ...
  polities: {
    ...
    // 가장 흥미로운 자리다.
    RSF: { name: "Russian SFSR", color: "#9e2222", aliases: ["러시아 SFSR", "소련", "Soviet Union", "USSR", "Russia", "Gorbachev", "고르바초프"] },
    UKS: { name: "Ukrainian SSR", color: "#a83030", aliases: ["우크라이나 SSR", "우크라이나", "Ukraine", "Rukh"] },
    BYE: { name: "Byelorussian SSR", color: "#932828", aliases: ["벨로루시 SSR", "백러시아", "Byelorussia", "Belarus"] },
    GEO: { name: "Georgian SSR", color: "#8e2020", aliases: ["그루지야 SSR", "조지아", "Georgia", "Tbilisi"] },
    ARM: { name: "Armenian SSR", color: "#a02a2a", aliases: ["아르메니아 SSR", "아르메니아", "Armenia", "Karabakh"] },
    AZE: { name: "Azerbaijan SSR", color: "#962e2e", aliases: ["아제르바이잔 SSR", "아제르바이잔", "Azerbaijan"] },
    UZB: { name: "Uzbek SSR", color: "#a43434", aliases: ["우즈베크 SSR", "우즈베키스탄", "Uzbekistan"] },
    TKM: { name: "Turkmen SSR", color: "#8f2626", aliases: ["투르크멘 SSR", "투르크메니스탄", "Turkmenistan"] },
    TJK: { name: "Tajik SSR", color: "#9a2c2c", aliases: ["타지크 SSR", "타지키스탄", "Tajikistan"] },
    KAZ: { name: "Kazakh SSR", color: "#912424", aliases: ["카자흐 SSR", "카자흐스탄", "Kazakhstan"] },
    KGZ: { name: "Kirghiz SSR", color: "#a63838", aliases: ["키르기스 SSR", "키르기스스탄", "Kyrgyzstan"] },
    EST: { name: "Estonian SSR", color: "#b04242", aliases: ["에스토니아 SSR", "에스토니아", "Estonia", "Rahvarinne"] },
    LVA: { name: "Latvian SSR", color: "#aa3c3c", aliases: ["라트비아 SSR", "라트비아", "Latvia"] },
    LTU: { name: "Lithuanian SSR", color: "#b44848", aliases: ["리투아니아 SSR", "리투아니아", "Lithuania", "Sajudis", "사유디스"] },
    MDA: { name: "Moldavian SSR", color: "#9c3232", aliases: ["몰다비아 SSR", "몰도바", "Moldova"] },
    // ── 바르샤바 조약: 아직 여섯 나라 ─────────────────────────────────────────
