...
export default {
  ...
  eraGeometry: {
    ...
    faceKeepOut: {
      ...
      "Byzantine Empire": ["MKD", "XKO", "TUR.16", "TUR.32", "TUR.66"], // 비잔티움면이 마케도니아+코소보 84지역을 삼켰다. TUR 셋은 나중에 붙였다: 면이 **오스만 베이릭의 세 지역을 전부** 가져가 보드 소개문이 "무명의 오스만 베이가 비잔티움 변경을 습격한다"고 말하는 그 나라가 0지역이었다 — 1299년 건국 직후인데 지도에 없었다는 뜻이다 — 1282년 밀루틴이 스코페를 가져갔고 스펙 주석도 그렇게 적혀 있다
  ...
  polities: {
    ...
    RUSP:  { name: "Russian Principalities", color: "#7a94b8", aliases: ["루스 공국들", "the Rus'", "Vladimir-Suzdal", "Novgorod", "Horde tributaries"] },
    GALI:  { name: "Galicia-Volhynia", color: "#a05a7a", aliases: ["갈리치아-볼히니아", "Kingdom of Ruthenia", "Halych-Volhynia"] },
    GORY:  { name: "Goryeo", color: "#5a9a7a", aliases: ["고려", "Korea", "Yuan vassal Korea"] },
    GEOR:  { name: "Kingdom of Georgia", color: "#5a9ac0", aliases: ["조지아 왕국", "Georgia", "Sakartvelo"] },
    ARM_C: { name: "Cilician Armenia", color: "#d98cae", aliases: ["킬리키아 아르메니아", "Little Armenia", "Armenian Cilicia"] },
    BULG:  { name: "Bulgarian Empire", color: "#8a5a3a", aliases: ["불가리아 제국", "Bulgaria", "Tarnovo"] },
    // — Western Europe —
    FRA_K: { name: "Kingdom of France", color: "#2f5fd0", aliases: ["프랑스 왕국", "France", "Philip the Fair's realm"] },
    ENG_K: { name: "Kingdom of England", color: "#b23b3b", aliases: ["잉글랜드 왕국", "England", "Plantagenet England"] },
    SCOT:  { name: "Kingdom of Scotland", color: "#6a6a9a", aliases: ["스코틀랜드 왕국", "Scotland", "Alba"] },
    CAST:  { name: "Crown of Castile", color: "#d2a02e", aliases: ["카스티야 왕국", "Castile", "Castile-León"] },
    ...
    PORT:  { name: "Kingdom of Portugal", color: "#2e7d6b", aliases: ["포르투갈 왕국", "Portugal"] },
    GRAN:  { name: "Emirate of Granada", color: "#2e7d4f", aliases: ["그라나다 토후국", "Granada", "Nasrids"] },
    HRE:   { name: "Holy Roman Empire", color: "#caa64a", aliases: ["신성 로마 제국", "the Empire", "Habsburg Empire"] },
    PAPAL: { name: "Papal States", color: "#e6d27a", aliases: ["교황령", "the Church", "Boniface VIII"] },
    NAPL:  { name: "Kingdom of Naples", color: "#c97a2e", aliases: ["나폴리 왕국", "Angevin Naples", "Regno"] },
    SICI:  { name: "Kingdom of Trinacria", color: "#c9385d", aliases: ["트리나크리아 왕국", "Sicily", "Aragonese Sicily"] },
    VEN:   { name: "Republic of Venice", color: "#8a7d3f", aliases: ["베네치아 공화국", "Venice", "La Serenissima"] },
    HUNG:  { name: "Kingdom of Hungary", color: "#3f9d9d", aliases: ["헝가리 왕국", "Hungary"] },
    POL_K: { name: "Kingdom of Poland", color: "#d23ca0", aliases: ["폴란드 왕국", "Poland", "Piast Poland"] },
    SERB:  { name: "Kingdom of Serbia", color: "#9a4f9a", aliases: ["세르비아 왕국", "Serbia", "Milutin's realm"] },
    LITH:  { name: "Grand Duchy of Lithuania", color: "#6b8e23", aliases: ["리투아니아 대공국", "Lithuania", "pagan Lithuania"] },
    TEUT:  { name: "Teutonic Order", color: "#aab4c4", aliases: ["튜턴 기사단", "the Order", "Ordensstaat", "Livonia"] },
    DEN_K: { name: "Kingdom of Denmark", color: "#b0486a", aliases: ["덴마크 왕국", "Denmark"] },
    ...
    BYZ:   { name: "Byzantine Empire", color: "#7d3fb2", aliases: ["동로마 제국", "Eastern Roman Empire", "Palaiologos Empire"] },
    OTTO:  { name: "Ottoman Beylik", color: "#6b4f2e", aliases: ["오스만 베이국", "Osman's beylik", "Ottomans"] },
    CYPR:  { name: "Kingdom of Cyprus", color: "#e07a7a", aliases: ["키프로스 왕국", "Lusignan Cyprus"] },
    MAML:  { name: "Mamluk Sultanate", color: "#3f8f5f", aliases: ["맘루크 술탄국", "Mamluks", "Egypt and Syria"] },
    // — Africa & Arabia —
    MAKU:  { name: "Makuria", color: "#9a6a3a", aliases: ["마쿠리아", "Nubia", "Dongola"] },
    ETHIO: { name: "Ethiopian Empire", color: "#4a8f6a", aliases: ["에티오피아 제국", "Abyssinia", "Solomonic Ethiopia"] },
    RASU:  { name: "Rasulid Yemen", color: "#6a8a3a", aliases: ["라술 왕조 예멘", "Rasulids", "Yemen"] },
    MALI:  { name: "Mali Empire", color: "#c2a23a", aliases: ["말리 제국", "Mali", "the Mansas"] },
    HAFS:  { name: "Hafsid Sultanate", color: "#4f7d2e", aliases: ["하프스 술탄국", "Hafsids", "Tunis"] },
    ZAYY:  { name: "Zayyanid Kingdom", color: "#7d6b2e", aliases: ["자이얀 왕국", "Zayyanids", "Tlemcen"] },
    MARI:  { name: "Marinid Sultanate", color: "#2e5d8f", aliases: ["마린 술탄국", "Marinids", "Fez"] },
    // — India & Southeast Asia —
    DELH:  { name: "Delhi Sultanate", color: "#3a7d4f", aliases: ["델리 술탄국", "Delhi", "Khalji Sultanate"] },
    PAND:  { name: "Pandya Empire", color: "#c07a4a", aliases: ["판디아 제국", "Pandyas", "Madurai"] },
    HOYS:  { name: "Hoysala Kingdom", color: "#6f8f3f", aliases: ["호이살라 왕국", "Hoysalas"] },
    YADA:  { name: "Yadava Kingdom", color: "#b8604a", aliases: ["야다바 왕국", "Yadavas", "Devagiri"] },
    KAKA:  { name: "Kakatiya Kingdom", color: "#8f5f8f", aliases: ["카카티야 왕국", "Kakatiyas", "Warangal"] },
    DAIV:  { name: "Dai Viet", color: "#4a8a5a", aliases: ["다이비엣", "Đại Việt", "Tran dynasty"] },
    KHMER: { name: "Khmer Empire", color: "#c97a5a", aliases: ["크메르 제국", "Angkor", "Cambodia"] },
    SUKH:  { name: "Sukhothai", color: "#d0b060", aliases: ["수코타이", "Ramkhamhaeng's kingdom", "Siam"] },
    MAJA:  { name: "Majapahit", color: "#6a7ab0", aliases: ["마자파힛", "Java", "Majapahit Empire"] },
