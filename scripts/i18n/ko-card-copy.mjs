...
const CARD_KO = {
  ...
  "zombie-2019": {
    name: "좀비 바이러스 아포칼립스",
    heroTitle: "아무도 준비되어 있지 않다",
    heroSubtitle: "완전히 평범한 한 해 — 2019년 1월 1일",
    subtitle: "2019년 1월 1일",
    description: "각국 정부는 무역 분쟁과 선거와 기후 정상회의를 준비하고 있다. 재래식 세계를 준비하고 있다. 당신에게는 그 세계가 1년 주어지고, 당신은 그 1년을 엉뚱한 문제에 쓸 것이다 — 어느 부처도, 어느 정보기관도, 아무도 무엇이 오는지 모르기 때문이다. 살아남는 나라는 대개 엉뚱한 이유로 옳은 것을 지어 둔 나라다.",
    eyebrow: "종말 이후",
  },
  "firerises-2020": {
    name: "파이어 라이지스 — 2020",
  ...
  "citizen-2026": {
    name: "2026 — 시민",
    heroTitle: "그런데 이번 달 월세는 낼 수 있나",
    heroSubtitle: "같은 세계, 그 바닥에서 — 2026년 1월 1일",
    subtitle: "2026년 1월 1일",
    description: "이 서재의 다른 보드는 전부 당신에게 나라를 준다. 이 보드는 사람을 준다 — 이름 하나, 가족 하나, 통장 잔고 하나, 그리고 당신이 고른 나라 어딘가의 주소. 전쟁과 선거는 여전히 일어나고 당신은 여전히 아무것도 할 수 없다. 할 수 있는 것은 취직하거나, 공부하거나, 떠나거나, 유명해지거나, 당선되거나, 이번 달을 넘기는 것이다. 세계는 어느 쪽이든 알아채지 못한다.",
    eyebrow: "한 사람의 시점",
  },
  "realworld-2026": {
    name: "리얼 월드 2026",
