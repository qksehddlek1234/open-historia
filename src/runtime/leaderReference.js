...
export const REFERENCE = {
  ...
  // ── 2020년 보드가 그리는 내전 당사자들 ────────────────────────────────────
  // modern-2020이 리비아·시리아·예멘·우크라이나 동부를 실제 지배자별로 그리므로
  // 그 정치체들도 이름이 있어야 한다. 이 파일의 doctrine 그대로: 확실한 인물만
  // 이름으로 적고, 확실치 않으면 사람 대신 실권을 쥔 자리를 적는다.
  "Government of National Accord": {
    leader: [
      { name: "총리 파예즈 알사라지", from: "2016-03-30", until: "2021-03-15" },
    ],
  },
  "Libyan National Army": {
    leader: [
      { name: "원수 칼리파 하프타르", from: "2014-05-16" },
    ],
  },
  // 구국정부에는 총리가 있지만 실권은 하이아트 타흐리르 알샴의 총사령관에게
  // 있고, 그쪽이 확실하다 — 2024년 12월 다마스쿠스에 들어가는 그 사람이다.
  "Syrian Salvation Government": {
    leader: [
      { name: "HTS 총사령관 아부 무함마드 알줄라니", from: "2017-11-02", until: "2024-12-08" },
    ],
  },
  // 자치행정부의 공동의장직은 윤번이 잦아 확실치 않다. 확실한 것은 시리아
  // 민주군 총사령관이고, 대외적으로 이 행정부를 대표하는 것도 그 사람이다.
  "Autonomous Administration of North and East Syria": {
    leader: [
      { name: "시리아 민주군 총사령관 마즐룸 압디", from: "2015-10-10" },
    ],
  },
  "Supreme Political Council": {
    leader: [
      { name: "최고정치위원회 의장 사리흐 알사마드", from: "2016-08-06", until: "2018-04-19" },
      { name: "최고정치위원회 의장 마흐디 알마샤트", from: "2018-04-23" },
    ],
  },
  // 2014년 이래의 분리주의 공화국 둘. 2018년 폭사 이후의 지도자들이다.
  "Donetsk People's Republic": {
    leader: [
      { name: "수반 알렉산드르 자하르첸코", from: "2014-11-04", until: "2018-08-31" },
      { name: "수반 데니스 푸실린", from: "2018-09-07" },
    ],
  },
  "Luhansk People's Republic": {
    leader: [
      { name: "수반 이고리 플로트니츠키", from: "2014-11-04", until: "2017-11-24" },
      { name: "수반 레오니트 파세치니크", from: "2017-11-24" },
    ],
  },
  Libya: {
    leader: [
